        ...
        <div class="relative">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between">
                <div class="mb-4 md:mb-0">
                    <h1 class="text-2xl sm:text-3xl font-bold mb-2">Faculty Dashboard</h1>
                    <p class="text-gray-300 text-sm sm:text-base">Welcome back, <?php echo htmlspecialchars($_SESSION['first_name']); ?></p>
                </div>
